...
if(typeof baseShowMain==='function')window.showMain=function(page){baseShowMain(page);const t=document.querySelector('#topLabel');if(t)t.textContent='ILIA COACH · ALL-IN-ONE · V7 · 3.0.1'};
...
function stamp(){document.title='ILIA COACH 3.0.1';const f=document.querySelector('.cover-foot');if(f)f.textContent='OFFICIAL · V7 · 3.0.1'}
