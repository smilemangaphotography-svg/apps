...
if(typeof baseShowMain==='function')window.showMain=function(page){baseShowMain(page);const t=document.querySelector('#topLabel');if(t)t.textContent='ILIA COACH · ALL-IN-ONE · BETA 2.9.3'};
...
function stamp(){document.title='ILIA Coach Beta 2.9.3';const f=document.querySelector('.cover-foot');if(f)f.textContent='LOCKED DESIGN · BETA 2.9.3'}
