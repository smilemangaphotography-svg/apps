...
public class MainActivity extends Activity {
    ...
    private void verifyRuntimeReady(WebView view, int attempt) {
        ...
        final String probe = "(function(){try{" +
                ...
                "return (p==='ready'&&s==='locked-all-in-one-2.9'&&m==='approved-functional'&&f==='2.9.3-runtime-ready'&&v==='3.0.1-calendar-ai-ready')?'ready':(p+'|'+s+'|'+m+'|'+f+'|'+v);" +
        ...
        view.evaluateJavascript(probe, value -> {
            ...
            if (attempt + 1 < RUNTIME_MAX_ATTEMPTS) {
                ...
                Toast.makeText(MainActivity.this, "ILIA COACH 3.0.1 runtime failed to initialize", Toast.LENGTH_LONG).show();
            }
        });
    }
