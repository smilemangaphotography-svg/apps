 ...
 try{
   ...
   try{
     ...
     const diag=await page.evaluate(()=>({
       preflight:window.__ILIA_RUNTIME_PREFLIGHT__||null,pt29:window.__PT_STYLE29__||null,v7:window.__ILIA_V7__||null,
       v73:window.__ILIA_V73_LIBRARY_TOOLS__||null,beta303:window.__KINETIQ_BETA303__||null,
       systemBeta:window.__KINETIQ_SYSTEM_BETA__||null,systemUI:window.__KINETIQ_SYSTEM_UI__||null,
       hasPT29:!!window.PT29,hasAdmin:!!window.PT29Admin,hasV7:!!window.ILIA_V7,hasV73:!!window.ILIA_V73,hasS:!!window.S,
